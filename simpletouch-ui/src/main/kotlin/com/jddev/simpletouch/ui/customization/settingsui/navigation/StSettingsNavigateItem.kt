...
import com.jddev.simpletouch.ui.customization.settingsui.SETTINGS_UI_DISABLE_ALPHA
...
import com.jddev.simpletouch.ui.customization.settingsui.StSettingsItemColors
import com.jddev.simpletouch.ui.customization.settingsui.StSettingsUi
import com.jddev.simpletouch.ui.customization.settingsui.StSettingsUiStyle
import com.jddev.simpletouch.ui.customization.settingsui.cupertinoValueTextStyle
...
private fun StSettingsNavigateItem(
    ...
    val settingsItemColors = value?.let {
        when (uiStyle) {
            ...
            else -> StSettingsItemColors.Default()
                .copy(subTitleColor = MaterialTheme.colorScheme.primary)
        }
    ...
    StSettingsBaseItem(
        ...
        trailingContent = {
            onClick?.let {
                Row(
                    Modifier.wrapContentHeight(), verticalAlignment = Alignment.CenterVertically
                ) {
        ...
        additionalLeadingIconPadding = if (uiStyle == StSettingsUiStyle.Cupertino) 0.dp else ADDITIONAL_LEADING_ICON_PADDING
    )
}
